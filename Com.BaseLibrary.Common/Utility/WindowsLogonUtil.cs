	...
	public class WindowsLogonUtil
	{
		...
		public static bool Login(String domain, String userName, String password)
		{
			...
			try
			{
				...
				bool retVal = DuplicateToken(tokenHandle, (int)LogonType.LOGON32_LOGON_INTERACTIVE, ref dupeTokenHandle);
				if (false == retVal)
				{
		...
		public static bool DomainLogin(String domain, String userName, String password)
		{
