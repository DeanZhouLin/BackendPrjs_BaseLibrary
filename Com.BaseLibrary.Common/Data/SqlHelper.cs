...
namespace Com.BaseLibrary.Data
{
    ...
    {
        #region ExecuteEntity & EntityList

        public static List<T> ExecuteEntityList<T>(string connectionString,
            string commandText,
            CommandType commandType,
            params SqlParameter[] parameters)
            where T : class, new()
        {
            DataTable dt = SqlHelper.ExecuteDataset(connectionString, commandType, commandText, parameters).Tables[0];
