...
{
    public class Jh99BillCoreTest
    {
		/// <summary>
		/// 商户编号
		/// </summary>
        public const string merchant_id = "10022124848";
		/// <summary>
		/// 支付账号
		/// </summary>
        public const string payment_merchant_id = "1002212484801";
        public const string PfxPassword = "asd123!@#";
        ...
        public const string PaymentUrl = "https://www.99bill.com/gateway/recvMerchantInfoAction.htm";


        public const string pfxFileName = "~/CER/99bill-rsa.pfx";
        public const string cerFileName = "~/CER/99bill.cert.rsa.20140728.cer";


		/// <summary>
		/// 人民币网关密钥
		/// </summary>
        public const string RMBGatewayMD5Key = "IBNKJ9YQ74MITZ4C";

		/// <summary>
		/// TY3Y75MSWW9GMMMS
		/// </summary>
        public const string AutoRefundMD5Key = "JFN3KEYKI35L8UQB";
		/// <summary>
		/// 人民币网关查询接口密钥
		/// </summary>
        public const string RMBGatewayQueryMD5Key = "JQJ6DHHZE5QUWNMB";
