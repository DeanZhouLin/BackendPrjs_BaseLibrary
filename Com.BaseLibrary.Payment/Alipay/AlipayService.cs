...
namespace Com.Alipay
{
    ...
    public class AlipayService
    {
        #region 字段
        //合作者身份ID
        private string _partner = "2088101171193303";
        //字符编码格式
        private string _input_charset = "";
        //签约支付宝账号或卖家支付宝帐户
        private string _seller_email = "alipay@jufine.com";
        //页面跳转同步返回页面文件路径
        ...
        /// 从配置文件及入口文件中初始化变量
        /// </summary>
        public AlipayService(string nodifyUrl)
        {
			_partner = AlipayConfiguration.Current.PartnerID.Trim();
			_input_charset = AlipayConfiguration.Current.InputCharset.Trim().ToLower();
			_seller_email = AlipayConfiguration.Current.SellerEmail.Trim();
            _notify_url = nodifyUrl;
        ...
        /// 从配置文件及入口文件中初始化变量
        /// </summary>
        public AlipayService(string returnUrl, string nodifyUrl)
        {
			_partner = AlipayConfiguration.Current.PartnerID.Trim();
			_input_charset = AlipayConfiguration.Current.InputCharset.Trim().ToLower();
			_seller_email = AlipayConfiguration.Current.SellerEmail.Trim();
        ...
        {
			string url = GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayConfiguration.Current.PartnerID;
            string encrypt_key = "";
        ...
        internal XmlDocument CreateSingleOrderQuery(SortedDictionary<string, string> sParaTemp)
        {
            //增加基本配置
