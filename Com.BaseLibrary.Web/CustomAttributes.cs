...
namespace Com.BaseLibrary.Web
{
    ...
    internal sealed class SR
    {
        private SR()
        {
            _rm = new ResourceManager("Com.BaseLibrary.Web.ListPager", GetType().Assembly);
        }
    ...
    /// <summary>
    /// ListPager type converter used for the design time support
    /// </summary>
    internal class AspNetPagerIDConverter : ControlIDConverter
    {
        protected override bool FilterControl(Control control)
        {
            if (control is ListPager)
                return true;
            return false;
        }
    }
